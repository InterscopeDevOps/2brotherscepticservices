  ...
  return (
    <>
      <div className="pic-wrapper svgHerosection1  w-full h-screen" >
        ...
        <div className="z-10 relative w-4/5 mx-auto h-full flex flex-col justify-center items-center md:pb-[160px] md:pt-[290px] pt-[250px] pb-[150px]">
      ...
      {/* <div className=" md:w-[70%] w-[100%] bg1 text-white md:-mt-32 -mb-12 -mt-20 relative md:py-14 py-2 homi">

    ...
    return (
        <header className='md:pt-[20px] bg2 w-full absolute top-0 z-50'>
            <div className='flex'>
                ...
                <div className='hidden md:block w-[65%] lg:w-[98%] h-50 self-center'>
                    <div className='flex items-center'>
                        <div className='w-[55%] lg:w-[85%]'>
                            <div className='flex justify-between items-center'>
                                <div className='flex text-white flex-row'>
                                    <div className='w-[100%] flex space-x-2 self-center mr-0'>
                                ...
                                <div className='hidden text-white  lg:flex'>
                                    <div className='w-[9%] self-center mr-5'>
                                ...
                                <div className='hidden lg:flex justify-end text-white'>
                                    <div className='w-[10%] self-center mr-4'>
